...
export const banner = {
  titlePart1: 'Fit in and make today your best',
  titlePart2: '– join here stay fit.',
  subtitle:
...
export const about = {
  ...
  title: 'Our mission',
  subtitle1:
    'At our gym, we believe in the power of inspiration to transform lives. With a motivating atmosphere, expert staff, and state-of-the-art equipment, we provide everything our members need to reach their fitness goals..',
  subtitle2:
    'We are committed to empowering each person who walks through our doors to become their best selves.',
  link: 'Join Now',
};
...
export const footer = {
  logo: Logo,
  copyrightText: 'All rights reserved by Manwar',
};
